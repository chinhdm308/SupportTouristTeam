...
//                startActivity(locationTeamActivity);
    ...
    private void loadData() {
        ...
        if (groupInfo != null) {
            if (groupInfo.getNumberOfPeople() == 2) {
                ...
                DatabaseReference reference = FirebaseDatabase.getInstance().getReference(Common.RF_USERS).child(userID);
    ...
    private void seenMessage(final String userId) {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference(Common.RF_CHATS);
    ...
    private void sendMessage(String sender, String receiver, String message) {
        ...
        databaseReference.child(Common.RF_CHATS).child(groupInfo.getId()).push().setValue(chat);
    }

    private void readMessage() {
        final DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference(Common.RF_CHATS)
    ...
    private GroupInfo getDataToIntent() {
        GroupInfo groupInfo = (GroupInfo) getIntent().getSerializableExtra(Common.EXTRA_GROUP_INFO);
