...
import dmc.supporttouristteam.presenter.register.RegisterContract;
import dmc.supporttouristteam.presenter.register.RegisterPresenter;
...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener, RegisterContract.View {
    ...
    private byte[] downsizedImageBytes  = null;
    ...
    private void init() {
        ...
        etDisplayName = findViewById(R.id.edt_display_name);
